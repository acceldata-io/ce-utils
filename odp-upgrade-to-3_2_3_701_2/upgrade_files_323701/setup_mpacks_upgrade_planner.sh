...
echo "[INFO] Same-stack Rolling packs from odp-ambari hf/ODP-2.7.8.601-2 are now also installed for 3.0, 3.1, and 3.3:"
echo "  grep -E '<target>|<target-stack>|<type>' $AMBARI_STACKS/3.0/upgrades/upgrade-3.0.xml $AMBARI_STACKS/3.1/upgrades/upgrade-3.1.xml $AMBARI_STACKS/3.3/upgrades/upgrade-3.3.xml"
