...
```
2. Navigate to `odp-upgrade-to-3_3_6_6_1` directory.
```
cd odp-upgrade-to-3_3_6_6_1
```
3. Execute the below command to add the pre-requisites to upgrade the cluster to `3.3.6.6-1`
```
