...
class AmbariConfigs:
    ...
    def get_config(self, config_type: str) -> dict:
        ...
        properties, attributes = get_current_config(self.cluster, config_type, self.accessor)
    ...
    def set_property(self, config_type: str, key: str, value: str, version_note: str = None):
    ...
    def set_properties(self, config_type: str, properties: dict, version_note: str = None):
    ...
    def delete_property(self, config_type: str, key: str, version_note: str = None):
        """Delete a property."""
