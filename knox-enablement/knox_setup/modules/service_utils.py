...
class ServiceUtils:
    ...
    def _api_request(self, endpoint: str, method: str = "GET", data: Optional[dict] = None) -> Optional[dict]:
        ...
        try:
            ...
            logger.error(f"Failed to make API request to Ambari: {e}")
            if e.code == 404:
                return None
            raise
    ...
    def stop_service(self, service_name: str, context: Optional[str] = None) -> Optional[int]:
    ...
    def start_service(self, service_name: str, context: Optional[str] = None) -> Optional[int]:
    ...
    def restart_services(self, service_names: list[str], context_prefix: str = "[knox-enablement]") -> bool:
        """
    ...
    def start_ambari_server(self, ssh_client) -> bool:
        ...
        if exit_code == 0:
            ...
            print("  ✗ ERROR: Failed to start Ambari server")
            return False
