...
"""
    ...
    def render_topology(self, hostnames: dict, protocol: str) -> str:
        """
        Render the topology template by replacing URL placeholders.
        Keeps {{}} Ambari-managed variables as-is.
        """
        content = files("templates").joinpath("knox-topology.j2").read_text()
...
def run(protocol: str = "http"):
    ...
    print("\n  Rendering topology...")
    topology_content = updater.render_topology(hostnames, protocol)
