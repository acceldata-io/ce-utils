...
cp upgrade_files_336/3.3/upgrades/nonrolling-upgrade-3.3.xml  /var/lib/ambari-server/resources/stacks/ODP/3.2/upgrades/

cp upgrade_files_336/3.3/upgrades/upgrade-3.3.xml   /var/lib/ambari-server/resources/stacks/ODP/3.2/upgrades/
...
echo "7. removing ranger-Admin and kms server's solr audit bootstrap warnings."
