...
export KEYSTORE_PASS="privateKeyPass"
export KNox_MASTER_SECRET_PASS="privateKeyPass"  # Knox master secret password used during installation
...
# Optionally provide an alias name; if not set, it will be auto-detected.
export ALIAS_NAME=""
...
confirm_configuration() {
    echo -e "\nPlease review the settings below before continuing:"
